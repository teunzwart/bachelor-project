...
\usepackage[backend=bibtex,bibencoding=ascii,style=ieee,sorting=none,giveninits=true,sortcites=true]{biblatex}
...
A repository containing the code use as well as the data sets that were generated may be found at \url{github.com/teunzwart/bachelor-project}, including a basic guide on how to use it.\todo{Currently this repository is still private.}
