...
Values of ratios of critical exponents also agree reasonably well as do critical exponents themselves, when compared to exact results.
...
Using the ratio \(\beta/\nu\) all critical exponents are in agreement with conjectured results while this is less so using \(\gamma/\nu\), possibly because of finite size scaling corrections.
...
De eerste was het Metropolis algoritme (In het plaatje zie je hoe het rooster verandert als het met dit algoritme gesimuleerd wordt.)
...
With larger and more system sizes, it would also be possible to find the change in critical exponents as data sets are left out while determining the critical exponents from a data collapse.
