...
\begin{table}[h]
	...
	\begin{center}
		\begin{tabular}{l | c c c c c c}
			...
			Den Nijs (1979, Conjecture)\cite{nijs:1979,baxter:1989} & \(\frac{1}{3}\) & \(\frac{1}{9}\) & \(\frac{13}{9}\) & \(\frac{4}{15}\) & \(\frac{5}{6}\) & 14 \\
			Blöte (1981)\cite{blote:1981} & & \\
			Fan (2007)\cite{fan:2007} & & \\
			Ghamei (2001)\cite{ghaemi:2001} & & \\
			Hu (1980)\cite{hu:1980} & & \\
			Straley (1973)\cite{straley:1973} & & \\\hline
		\end{tabular}
	\end{center}
	\caption{The critical exponents of the three-state Potts model. Values marked with a star are derived from values mentioned in papers using scaling relations.}
\end{table}
