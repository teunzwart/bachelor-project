...
class MetropolisIsing:
    ...
    def exact_magnetization(self, lower_temperature, higher_temperature, step=0.02):
        """
    ...
    def exact_internal_energy(self, lower_temperature, higher_temperature, step=0.02):
        """
    ...
    def exact_heat_capacity(self, lower_temperature, higher_temperature, step=0.02):
        """
